...
function hotkeysConstruct(key, option, method) {
...
function hotkeys(key, option, method) {
  return hotkeysConstruct(key, option, method);
}

function getIsBind() {
  return isBindElement;
};

function setIsBind(value) {
  isBindElement = value
};
...
var _api = {
  ...
  hotkeysConstruct: hotkeysConstruct
};
for (var a in _api) {
